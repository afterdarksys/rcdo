...
var configurableFlags = map[string]map[string]bool{
	...
	"ops-policy-check":    flagSet("format", "environment", "policy"),
	"repo-policy-check":   flagSet("format", "environment", "policy", "repo-policy"),
	"tofu-check":          flagSet("format", "environment", "policy"),
	"ansible-check":       flagSet("format", "environment", "policy"),
	"cloud-context-check": flagSet("format", "environment", "policy"),
}
